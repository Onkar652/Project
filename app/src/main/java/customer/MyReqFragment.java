...
public class MyReqFragment extends Fragment {
            ...
            mFirebaseDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for (DataSnapshot requestSnapshot : dataSnapshot.getChildren()) {
                        ...
                        if (rideRequest != null && rideRequest.getReqid().equals(uid)) {
    ...
    public class RideRequestAdapter extends RecyclerView.Adapter<RideRequestAdapter.ViewHolder> {
        ...
        @NonNull
        @Override
        public RideRequestAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.myreq_row, parent, false);
            return new RideRequestAdapter.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull RideRequestAdapter.ViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    RideRequest rideRequest = rideRequestsList.get(position);
                    // Open the RideDetailsActivity and pass the RideRequest object
